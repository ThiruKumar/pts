...
$count =  count($param);
for($i=1;$i<=$count-1;$i++){	
				$site = "https://automatedreporting.masscec-pts.com/ptsproduction/GetSubmissionStatus";	
				$inputData = array('APIKey'=>'69667be9618b402b9b0a3ffdd7edfb52','systems'=>array($param[$i]));
				$inputparam = json_encode($inputData);
				$request_headers = array(
						"Ocp-Apim-Subscription-Key:69667be9618b402b9b0a3ffdd7edfb52" 
									  );
				...
				?>
				<tr>
				<td><?php print_r($data[0]["fk_system"]);?></td>
				<td><?php print_r($data[0]["MeterValue"]);?></td>
				<td><?php print_r($data[0]["EnergyProduced"]);?></td>
                <td><?php if($data[0]["ErrorNotes"]==null ){echo "Null";} else {print_r($data[0]["ErrorNotes"]);}?></td>
				<td><?php print_r($data[0]["ValidationStatus"]);?></td>
				</tr>
...
function ExportToExcel(type, fn, dl) {
       ...
       return dl ?
         ...
         XLSX.writeFile(wb, fn || ('PTS_validation_status.' + (type || 'xlsx')));
    }
</script>
</html>